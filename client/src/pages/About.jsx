...
const About = () => {
  return (
    <div className='w-[90vw] sm:w-[1120px] mx-auto my-12 flex flex-col gap-4 p-3' >
      <h1 className='text-3xl text-slate-800 font-bold '>About Deni Estate</h1>
      <p   className='text-slate-700' >
      Deni Estate is a leading real estate agency that specializes in helping clients buy, 
      sell, and rent properties in the most desirable neighborhoods. Our team of 
      experienced agents is dedicated to providing exceptional service and making the buying 
